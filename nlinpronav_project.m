...
% Parameters are nT
%
function [dy] = nlinpronav_project(t, y, He_rad, Np, nT, A, B, C, D)
...
%% Acheived Acceleration
nc_achieved = C(1,:)*y(10:17) + D(1,1)*nc;
...
dy(8) = -nc_achieved*sin(lambda)
dy(9) =  nc_achieved *cos(lambda);
dy(10:17) = A*y(10:17) + B*nc;
end
